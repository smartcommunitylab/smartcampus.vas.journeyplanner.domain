...
public class  GetOrdinanzeRoveretoInterface extends DomainTypeInterfaceImpl {

    private static DomainTypeInterface intf = null;
    public static DomainTypeInterface getInstance() {
        if (intf==null) intf = new GetOrdinanzeRoveretoInterface();
        return intf;
    }
    ...
    static {
        ...
        e = smartcampus.services.journeyplanner.RoadAlertSenderInterface .getInstance();
        extended.add(e);
    }    
    ...
    static {
        ...
        o = new OperationImpl();
        o.setName("subscribeOrdinanzeRovereto");
